    ...
    <View style={{ flex: 1, backgroundColor: '#fafafa', marginTop: 0 }}>
      ...
      {hasSend === false ? (
        <View
          ...
          <Text style={{ alignSelf: 'flex-start', marginLeft: 28, fontSize: 12, fontWeight: '300', color: 'orange' }}>
            {'NB: Minimun cashout : $10'}
          </Text>
          ...
          <Text style={{}}>
            ...
            <Text
              style={{
                ...
                fontSize: 16,
                fontWeight: '700',
                color: parseFloat(amount) - 1.2 < 0 ? 'red' : 'green',
              }}>
              ${amount ? (parseFloat(amount) - 1.2).toFixed(2) : '0.0'}
            </Text>
          </Text>
          {address !== '' &&
            receiver &&
              ...
              <View>
                {sending === false && parseFloat(amount) >= 10 ? (
                  <TouchableOpacity
                    ...
                    <Text style={styles.textStyle}>Cash Out Money</Text>
                  </TouchableOpacity>
                ) : (
